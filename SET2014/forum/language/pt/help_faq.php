...
$help = array(
	...
	array(
		0	=> 'O que é <b>COPPA</b>?',
		1	=> 'A <a href="http://www.coppa.org/coppa.htm" target="_blank";" title="Abrir numa janela nova"><em><b>COPPA</b> (Childrens Online Privacy Protection Act)</em></a> é uma Lei de 1998 dos EUA que exige uma autorização para guardar as informações relativas a menores de 13 anos de idade.',
	),
	array(
   ...
   array( 
	...
	array(
		...
		1	=> 'O acesso a algumas seções poderá estar limitado apenas a determinados <b>Utilizadores</b> ou Grupos. Para ver, ler, enviar Mensagens, etc., tem que ter de uma autorização especial. Apenas o Moderador dessa secção e um <b>Administrador</b> podem permitir esse acesso. Entre em contacto, caso ache necessário.',
	),
	array(
	...
	array(
		...
		1	=> 'Este Software é produzido, publicado e com direitos reservados pelo <a href="https://www.phpbb.com" target="_blank";" title="Abrir numa janela nova"><b>phpBB Group</b></a>. Está disponível sob a licença <b>GNU - General Public Licence</b> e pode ser distribuído gratuitamente.',
	),
	array(
		0	=> 'Quem traduziu o phpBB3?',
		1	=> 'O phpBB3 foi traduzido para a Língua Portuguesa por <a href="https://phpbbportugal.com" target="_blank"><b>phpBB Portugal</b></a>, sendo esta tradução de distribuição livre e gratuita. Se encontrar erros ou incorreções, ou ainda, se tiver alguma sugestão a fazer visite-nos em <a href="http://phpbbportugal.com" target="_blank"><b>phpBB Portugal</b></a>. Agradecemos antecipadamente a sua visita e as contribuições que entender dar-nos, prometendo analisá-las cuidadosamente e dar-lhe resposta tão breve quanto possível.',
	),
	array(
