...
$lang = array_merge($lang, array(
	...
	'GROUP_EDIT_EXPLAIN'				=> 'Aqui pode configurar os Grupos existentes. Alterar o nome (<em>exceto dos Grupos Pré-Definidos, onde o nome não pode ser alterado</em>), descrição e estado (Aberto/Fechado). Também é possível especificar outras opções como a cor, a classificação, etc. As alterações aqui feitas afetarão os Membros do Grupo. De notar que os Membros do Grupo podem alterar os Avatares a não ser que selecione as Permissões de Utilizadores apropriadas.',
