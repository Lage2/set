...
<fieldset class="fields1">
	...
	<dl>
		<dt><label for="icon"><span style="color: #333333;"><?php echo ((isset($this->_rootref['L_ICON'])) ? $this->_rootref['L_ICON'] : ((isset($user->lang['ICON'])) ? $user->lang['ICON'] : '{ ICON }')); ?>:</span></label></dt>
		<dd>
	...
	<dl style="clear: left;">
		<dt><label for="subject"><span style="color: #333333;"><?php echo ((isset($this->_rootref['L_SUBJECT'])) ? $this->_rootref['L_SUBJECT'] : ((isset($user->lang['SUBJECT'])) ? $user->lang['SUBJECT'] : '{ SUBJECT }')); ?>:</span></label></dt>
