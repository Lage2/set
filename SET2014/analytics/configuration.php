...
// Database Connection
$db_host = 'db.ist.utl.pt'; // database server (e.g. localhost)
$db_user = 'g02480_settagus'; // user
$db_pass = 'wiekieshei'; // password
$db_name = 'g02480_settagus';// database name
$db_prefix = 'stats'; // database prefix
